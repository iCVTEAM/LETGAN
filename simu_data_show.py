...
def main(args):
    ...
    desPath = '/media/localdisk1/usr/gdx/project/20200721_ED/ED/Demo'
    ...
    for step, scene in enumerate(scene_list):
        ...
        info = readconfig('/media/localdisk1/usr/gdx/project/20200721_ED/esim_config_generator/data/configs2/000000000_autoscene.txt')
        ...
        for index in range(num_data):
            ...
            for i in range(0,260):
                ...
                if i == 50 or i == 150 or i == 250:
                    imageio.imwrite(os.path.join(desPath,str(i).zfill(5)+'.png'), ((image[0].cpu().data.numpy()).transpose(1,2,0).astype(np.uint8)))
                #img[:,i:i+1]=image
